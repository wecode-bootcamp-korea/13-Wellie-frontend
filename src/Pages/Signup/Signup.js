...
import SocialPlatforms from "../Login/components/SocialPlatforms";
...
export default class Signup extends Component {
  ...
  goToPhoneValidate = () => {
    this.props.history.push("/phone_validate");
  };
    ...
    return (
      <StyledSignup>
        ...
        <SignupContents>
          ...
          <SignupContainer>
            <SignupButton onClick={this.goToPhoneValidate}>
              휴대폰 번호로 시작하기
            </SignupButton>
            <Or>또는</Or>
            <SocialPlatforms />
            <LoginSignupLinkContainer>
...
const LoginSignupLinkContainer = styled.ul`
  width: 100%;
  display: flex;
  justify-content: center;
  align-items: center;
